...
| 1 operation claim | bounded canonical intent、同一 credential/key、claim 競合/応答喪失/current auth、lookup の情報制限 | create/rename/PROPPATCH/PUT の内部サービス実装。DAV PROPPATCH、MKCOL、PUT は HTTP 接続済み |
