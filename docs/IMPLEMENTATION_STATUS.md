...
- **M**: `0001`〜`0012` を追加し、隔離 D1 と SQLite へ適用して FK/CHECK/trigger/FTS/会計/permit/operation/outbox identity/DAV lock display href を確認。リモート DB は未変更。probe schema は別 test file に隔離。
