...
67通常テーブル、migration `0001`〜`0030`、147経路の契約があり、主要なFiles REST/WebDAV mutation、trash/restore/purge、fenced R2 GC、content ticket/blob配信、private単一・分割アップロードまでローカル接続しています。
...
[namespace更新の全体受付](docs/MUTATION_ADMISSION.md)は同時32件・待機256件で接続済みです。認証やupload準備など他の更新経路への接続は残っています。
