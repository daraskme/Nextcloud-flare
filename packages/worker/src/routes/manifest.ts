...
export const routeManifest = [
  ...
  route("OPTIONS", "/dav/*path", "app_password", "dav.options", 7, "dav"),
  route("PROPFIND", "/dav/*path", "app_password", "dav.propfind", 7, "dav"),
  route("PROPPATCH", "/dav/*path", "app_password", "dav.proppatch", 7, "dav"),
  route("MKCOL", "/dav/*path", "app_password", "dav.mkcol", 7, "dav"),
  route("GET", "/dav/*path", "app_password", "dav.read", 7, "dav"),
  route("HEAD", "/dav/*path", "app_password", "dav.read", 7, "dav"),
  route("PUT", "/dav/*path", "app_password", "dav.put", 7, "dav"),
  route("DELETE", "/dav/*path", "app_password", "dav.delete", 7, "dav"),
  route("COPY", "/dav/*path", "app_password", "dav.copy", 7, "dav"),
  route("MOVE", "/dav/*path", "app_password", "dav.move", 7, "dav"),
  route("LOCK", "/dav/*path", "app_password", "dav.lock", 7, "dav"),
  route("UNLOCK", "/dav/*path", "app_password", "dav.unlock", 7, "dav"),
